...
if ( ! class_exists( 'CoursePress_Shortcodes' ) ) {
	...
	class CoursePress_Shortcodes extends CoursePress {
		...
		function __construct() {
			...
			add_shortcode( 'course_unit_title', array( &$this, 'course_unit_title' ) );
			add_shortcode( 'course_unit_page_title', array( &$this, 'course_unit_page_title' ) );
