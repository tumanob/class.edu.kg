...
function coursepress_get_invitation_passcode_email_subject() {
	return get_option( 'invitation_passcode_email_subject', __( 'Invitation to a Course ( Psss...for selected ones only )', 'coursepress' ) );
}
...
Yours sincerely,
%5$s Team', 'coursepress' ), 'STUDENT_FIRST_NAME', 'COURSE_NAME', 'COURSE_EXCERPT', '<a href="COURSE_ADDRESS">COURSE_ADDRESS</a>', '<a href="WEBSITE_ADDRESS">WEBSITE_ADDRESS</a>', 'PASSCODE' );
...
function coursepress_get_invitation_email_subject() {
	return get_option( 'invitation_email_subject', __( 'Invitation to a Course', 'coursepress' ) );
}
...
Yours sincerely,
%5$s Team', 'coursepress' ), 'STUDENT_FIRST_NAME', 'COURSE_NAME', 'COURSE_EXCERPT', '<a href="COURSE_ADDRESS">COURSE_ADDRESS</a>', '<a href="WEBSITE_ADDRESS">WEBSITE_ADDRESS</a>' );
...
function coursepress_get_registration_email_subject() {
	return get_option( 'registration_email_subject', __( 'Registration Status', 'coursepress' ) );
}
...
Yours sincerely,
%5$s Team', 'coursepress' ), 'STUDENT_FIRST_NAME', 'BLOG_NAME', '<a href="LOGIN_ADDRESS">LOGIN_ADDRESS</a>', '<a href="COURSES_ADDRESS">COURSES_ADDRESS</a>', '<a href="WEBSITE_ADDRESS">WEBSITE_ADDRESS</a>' );
...
function coursepress_get_mp_order_email_subject() {
	return get_option( 'mp_order_email_subject', __( 'Order Confirmation', 'coursepress' ) );
}
...
Yours sincerely,
%5$s Team', 'coursepress' ), 'CUSTOMER_NAME', '<a href="COURSE_ADDRESS">COURSE_TITLE</a>', '<a href="STUDENT_DASHBOARD">' . __( 'Dashboard', 'coursepress' ) . '</a>', '<a href="COURSES_ADDRESS">COURSES_ADDRESS</a>', 'BLOG_NAME' );
...
function coursepress_get_enrollment_email_subject() {
	return get_option( 'enrollment_email_subject', __( 'Enrollment Confirmation', 'coursepress' ) );
}
...
Yours sincerely,
%5$s Team', 'coursepress' ), 'STUDENT_FIRST_NAME', '<a href="COURSE_ADDRESS">COURSE_TITLE</a>', '<a href="STUDENT_DASHBOARD">' . __( 'Dashboard', 'coursepress' ) . '</a>', '<a href="COURSES_ADDRESS">COURSES_ADDRESS</a>', 'BLOG_NAME' );
...
function cp_get_instructor_invitation_email_subject() {
	return get_option( 'instructor_invitation_email_subject', sprintf( __( 'Invitation to be an instructor at %s', 'coursepress' ), get_option( 'blogname' ) ) );
}
...
%4$s
	'
	, 'coursepress' ), 'INSTRUCTOR_FIRST_NAME', 'COURSE_NAME', '<a href="CONFIRMATION_LINK">CONFIRMATION_LINK</a>', '<a href="WEBSITE_ADDRESS">WEBSITE_ADDRESS</a>'
	);
