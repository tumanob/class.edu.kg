...
<div id="comments" class="comments-area discussion-comments">
    ...
    $comments_args = array(
        ...
        'title_reply' => __( 'Answer the Question', "coursepress" ),
        'title_reply_to' => __( 'Leave a Reply to %s' ),
        'cancel_reply_link' => __( 'Cancel Reply' ),
        'label_submit' => __( 'Answer the Question', "coursepress" ),
        'comment_field' => '<p class="comment-form-comment"><label for="comment">' .
        '</label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" palceholder="' . __( 'Write a response', "coursepress" ) . '">' .
        '</textarea></p>',
        'must_log_in' => '',
        'logged_in_as' => '',
