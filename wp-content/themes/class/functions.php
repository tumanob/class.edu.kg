...
function coursepress_scripts() {
	...
	wp_enqueue_style( 'bootstrap-min', get_template_directory_uri() . '/inc/bootstrap/css/bootstrap.min.css' );
	...
	wp_enqueue_script( 'bootstrap-custom-script', get_template_directory_uri() . '/inc/bootstrap/js/bootstrap.min.js', array( 'jquery' ), '20150615', true );
