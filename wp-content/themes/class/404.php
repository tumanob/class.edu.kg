		...
		<main id="main" class="site-main" role="main">
			...
			<section class="error-404 not-found">
				<header class="page-header">
					<h1 class="page-title"><?php _e( 'Oops! That page can&rsquo;t be found.', 'coursepress' ); ?></h1>
				</header><!-- .page-header -->
				...
				<div class="page-content">
					...
					$archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', "coursepress" ), convert_smilies( ': )' ) ) . '</p>';
